...
<section>
    <div class="container">
        <div class="row justify-content-center">
            <h2 class="title text-center mb-4">Додати видавництво</h2>
        </div>
        <div class="row">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Додати видавництво</li>
              </ol>
            </nav>
        </div>
        <div class="row justify-content-center">
                   ...
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="publisher_name" value="<?=$publisherName;?>" maxlength="150">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
