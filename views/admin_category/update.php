                ...
                <ul class="list-group">
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="book_id" value="<?php if ($options) echo $options['id'];?>"
                             pattern="^[0-9-●]{7,}$">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="name" value="<?php if ($options) echo $options['name'];?>" minlength="2" maxlength="100">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                   ...
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="year" value="<?php if ($options) echo $options['year'];?>">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="number" name="page_count" value="<?php if ($options) echo $options['pages'];?>">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" name="photo_file" type="file">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
