        ...
        <div class="row">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="/admin">Таблиця "Книги"</a></li>
                ...
                <ul class="list-group">
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="book_id" value=""
                             pattern="^[0-9-●]{7,}$">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="name" value="" minlength="5" maxlength="100">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                   ...
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="text" name="year" value="">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
                      <div class="row">
                         ...
                         <div class="col-md-7 col-sm-7 col-lg-7">
                             <input class="form-control" required type="number" name="page_count" value="">
                         </div>
                      </div>
                   </li>
                   <li class="list-group-item">
